               ...
               <div class="card-body">
                     ...
                     <div class="col-md-3">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-primary mr-1" ID="LinkButton4" runat="server" Text="Go" OnClick="LinkButton4_Click"/>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-4">
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-success mr-1" OnClick="LinkButton1_Click" ID="LinkButton1" runat="server" Text="A"> <i class="fa-regular fa-circle-check fa-sm"></i> </asp:LinkButton>
                              <asp:LinkButton class="btn btn-warning mr-1" OnClick ="LinkButton2_Click" ID="LinkButton2" runat="server"> <i class="far fa-pause-circle"></i></asp:LinkButton>
                              <asp:LinkButton class="btn btn-danger mr-1" OnClick ="LinkButton3_Click"  ID="LinkButton3" runat="server"> <i class="fas fa-times-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger"  OnClick ="Button2_Click" runat="server" Text="Delete User Permanently" />
                     </div>
                  </div>
               </div>
            </div>
